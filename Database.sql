...
LOAD DATA INFILE 'E:\Tedycup-main/Tedycup-main/Tedy_cup/A_quest/file2.csv' 
/*这一部分是导入数据*/
INTO TABLE meber_info CHARACTER SET utf8 /*这里一定要注意格式*/
...
LOAD DATA INFILE 'E:\Tedycup-main/Tedycup-main/Tedy_cup/A_quest/file3.csv'
/*这一部分是导入数据*/
INTO TABLE position_info CHARACTER SET utf8 /*这里一定要注意格式*/
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
(grid_point_id,pname,point_type,x_coordinate,y_coordinate,create_time);
DROP TABLE SELFsearching_info;
CREATE TABLE SELFsearching_info/*创建个人自查上报信息表*/
(
    sno BIGINT(20) COMMENT '序列号：自查记录唯一标识',
...
LOAD DATA INFILE 'E:\Tedycup-main/Tedycup-main/Tedy_cup/A_quest/file4.csv'
/*这一部分是导入数据*/
INTO TABLE SELFsearching_info CHARACTER SET utf8 /*这里一定要注意格式*/
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
(sno,userid,x_coordinate,y_coordinate,symptom,nucleic_acid_result,resident_flag,dump_time);
...
LOAD DATA INFILE 'E:\Tedycup-main/Tedycup-main/Tedy_cup/A_quest/file5.csv'
/*这一部分是导入数据*/
INTO TABLE place_code_scanning_info CHARACTER SET utf8 /*这里一定要注意格式*/
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
(sno,grid_point_id,userid,temperature,create_time);
...
LOAD DATA INFILE 'E:\Tedycup-main/Tedycup-main/Tedy_cup/A_quest/file6.csv'
/*这一部分是导入数据*/
INTO TABLE NA_Sampling_Detection CHARACTER SET utf8 /*这里一定要注意格式*/
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
(sno,userid,cysj,jcsj,jg,grid_point_id);
...
LOAD DATA INFILE 'E:\Tedycup-main/Tedycup-main/Tedy_cup/A_quest/file7.csv'
/*这一部分是导入数据*/
INTO TABLE Vaccination_record CHARACTER SET utf8 /*这里一定要注意格式*/
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
(sno,inject_sn,userid,age,gender,birthdate,inject_date,inject_times,vaccine_type);
